...
import "../interfaces/external/IComptroller.sol";
...
contract CompoundStrategy is InitializableAbstractStrategy {
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < assetsMapped.length; i++) {
            ICERC20 _cToken = _getCTokenFor(assetsMapped[i]);
            ctokensToCollect[i] = address(_cToken);
        }
        ...
        IERC20Upgradeable rewardToken = IERC20Upgradeable(rewardTokenAddresses[0]);
